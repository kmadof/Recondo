...
**
** Created: Sun 10. Jun 09:55:39 2012
...
public:
    ...
    QLabel *lbNewItems;
    QLabel *lbRepeat;
    QLabel *lbHarmonogramNumber;
    QLabel *lbNewItemsNumber;
    QLabel *lbRepeatNumber;
    QGroupBox *gbCurrentCourse;
    QWidget *gridLayoutWidget_2;
    QGridLayout *gridLayout_2;
    QLabel *lbCourseNameInfo;
    QLabel *lbCourseName;
    QMenuBar *menuBar;
    QMenu *menuFile;
    QMenu *menuUser;
    ...
    void setupUi(QMainWindow *RecondoUIClass)
    {
        ...
        RecondoUIClass->setMinimumSize(QSize(725, 350));
        RecondoUIClass->setMaximumSize(QSize(725, 350));
        ...
        actionEndLection = new QAction(RecondoUIClass);
        actionEndLection->setObjectName(QString::fromUtf8("actionEndLection"));
        actionEndLection->setEnabled(false);
        ...
        btnQualityZero->setEnabled(false);
        ...
        btnQualityOne->setEnabled(false);
        ...
        btnQualityTwo->setEnabled(false);
        ...
        btnQualityThree->setEnabled(false);
        ...
        btnQualityFour->setEnabled(false);
        ...
        btnQualityFive->setEnabled(false);
        ...
        gbCurrentLection->setGeometry(QRect(10, 70, 161, 101));
        ...
        lbHarmonogramNumber = new QLabel(formLayoutWidget);
        lbHarmonogramNumber->setObjectName(QString::fromUtf8("lbHarmonogramNumber"));

        gridLayout->addWidget(lbHarmonogramNumber, 0, 1, 1, 1);
        ...
        gridLayout->addWidget(lbRepeatNumber, 2, 1, 1, 1);

        gbCurrentCourse = new QGroupBox(centralWidget);
        gbCurrentCourse->setObjectName(QString::fromUtf8("gbCurrentCourse"));
        gbCurrentCourse->setGeometry(QRect(10, 10, 161, 51));
        gridLayoutWidget_2 = new QWidget(gbCurrentCourse);
        gridLayoutWidget_2->setObjectName(QString::fromUtf8("gridLayoutWidget_2"));
        gridLayoutWidget_2->setGeometry(QRect(10, 20, 141, 21));
        gridLayout_2 = new QGridLayout(gridLayoutWidget_2);
        gridLayout_2->setSpacing(6);
        gridLayout_2->setContentsMargins(11, 11, 11, 11);
        gridLayout_2->setObjectName(QString::fromUtf8("gridLayout_2"));
        gridLayout_2->setContentsMargins(0, 0, 0, 0);
        lbCourseNameInfo = new QLabel(gridLayoutWidget_2);
        lbCourseNameInfo->setObjectName(QString::fromUtf8("lbCourseNameInfo"));

        gridLayout_2->addWidget(lbCourseNameInfo, 0, 0, 1, 1);

        lbCourseName = new QLabel(gridLayoutWidget_2);
        lbCourseName->setObjectName(QString::fromUtf8("lbCourseName"));

        gridLayout_2->addWidget(lbCourseName, 0, 1, 1, 1);
        ...
        menuUser->addAction(actionEndLection);
    ...
    void retranslateUi(QMainWindow *RecondoUIClass)
    {
        ...
        actionEndLection->setText(QApplication::translate("RecondoUIClass", "Zako\305\204cz lekcj\304\231", 0, QApplication::UnicodeUTF8));
        btnQualityZero->setText(QApplication::translate("RecondoUIClass", "0", 0, QApplication::UnicodeUTF8));
        btnQualityOne->setText(QApplication::translate("RecondoUIClass", "1", 0, QApplication::UnicodeUTF8));
        ...
        lbHarmonogramNumber->setText(QApplication::translate("RecondoUIClass", "0", 0, QApplication::UnicodeUTF8));
        ...
        gbCurrentCourse->setTitle(QApplication::translate("RecondoUIClass", "Obecny kurs", 0, QApplication::UnicodeUTF8));
        lbCourseNameInfo->setText(QApplication::translate("RecondoUIClass", "Nazwa kursu:", 0, QApplication::UnicodeUTF8));
        lbCourseName->setText(QString());
